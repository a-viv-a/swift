...
func test_parameter_pack_actor_nonsendable_not_disconnected() async {
  ...
  await a.message(value) // expected-swift5-warning {{sending value of non-Sendable type 'NS' risks causing data races; this is an error in the Swift 6 language mode}}
