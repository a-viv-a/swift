...
struct Bar: Sendable {
  ...
  var foo: Foo // expected-warning {{stored property 'foo' of 'Sendable'-conforming struct 'Bar' has non-Sendable type 'Foo'; this is an error in the Swift 6 language mode}}
}
