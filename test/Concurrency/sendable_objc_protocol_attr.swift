...
do {
  ...
  final class B : A, P {
    // expected-warning@-1 {{'Sendable' class 'B' cannot inherit from another class other than 'NSObject'; this is an error in the Swift 6 language mode}}
  }
  ...
  class C : A, MyObjCProtocol {
    ...
    // expected-warning@-2 {{'Sendable' class 'C' cannot inherit from another class other than 'NSObject'; this is an error in the Swift 6 language mode}}
    let test: String = "c"
  }
  ...
  final class D : A, Q {
    // expected-warning@-1 {{'Sendable' class 'D' cannot inherit from another class other than 'NSObject'; this is an error in the Swift 6 language mode}}
  }
