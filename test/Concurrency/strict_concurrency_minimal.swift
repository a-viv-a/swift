...
struct S1: Sendable {
  let c1: C1 // expected-warning{{stored property 'c1' of 'Sendable'-conforming struct 'S1' has non-Sendable type 'C1'; this is an error in the Swift 6 language mode}}
  let c2: C2 // expected-warning{{stored property 'c2' of 'Sendable'-conforming struct 'S1' has non-Sendable type 'C2'; this is an error in the Swift 6 language mode}}
  let c3: C3 // expected-warning{{stored property 'c3' of 'Sendable'-conforming struct 'S1' has non-Sendable type 'C3'; this is an error in the Swift 6 language mode}}
}
...
func passSendable(
  ...
  takeSendable { print(c1) } // expected-targeted-warning {{capture of 'c1' with non-Sendable type 'C1' in a '@Sendable' closure; this is an error in the Swift 6 language mode}}
  takeSendable { print(fn) } // expected-targeted-warning {{capture of 'fn' with non-Sendable type '() -> Void' in a '@Sendable' closure; this is an error in the Swift 6 language mode}}
  ...
  takeSendable { print(c2) } // expected-warning {{capture of 'c2' with non-Sendable type 'C2' in a '@Sendable' closure; this is an error in the Swift 6 language mode}}
  takeSendable { print(c3) } // expected-warning {{capture of 'c3' with non-Sendable type 'C3' in a '@Sendable' closure; this is an error in the Swift 6 language mode}}
  ...
  takeSendable { print(s2) } // expected-targeted-warning {{capture of 's2' with non-Sendable type 'S2' in a '@Sendable' closure; this is an error in the Swift 6 language mode}}
  ...
  takeSendable { print(s3) } // expected-targeted-warning {{capture of 's3' with non-Sendable type 'S3' in a '@Sendable' closure; this is an error in the Swift 6 language mode}}
}
